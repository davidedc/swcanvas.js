...
- **Comprehensive Test Coverage**: 86 core tests + 154 visual tests + 79 direct rendering tests
...
- `tests/dist/core-functionality-tests.js` from 86 individual test files in `/tests/core/`
...
This runs:
- 86 modular core functionality tests (automatically uses built tests from `/tests/core/`)
