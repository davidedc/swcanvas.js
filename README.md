...
- **Comprehensive Test Coverage**: 82 core tests + 154 visual tests + 79 direct rendering tests
...
- `tests/dist/core-functionality-tests.js` from 82 individual test files in `/tests/core/`
...
This runs:
- 82 modular core functionality tests (automatically uses built tests from `/tests/core/`)
