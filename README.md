...
- **Comprehensive Test Coverage**: 88 core tests + 154 visual tests + 79 direct rendering tests
...
- `tests/dist/core-functionality-tests.js` from 88 individual test files in `/tests/core/`
...
This runs:
- 88 modular core functionality tests (automatically uses built tests from `/tests/core/`)
