...
- **Comprehensive Test Coverage**: 37 core tests + 144 visual tests + 79 direct rendering tests
...
- `tests/dist/core-functionality-tests.js` from 37 individual test files in `/tests/core/`
- `tests/dist/visual-rendering-tests.js` from 144 individual test files in `/tests/visual/`
...
This runs:
- 37 modular core functionality tests (automatically uses built tests from `/tests/core/`)
- 144 visual rendering tests generating PNG files in `tests/output/`
...
- All 144 visual rendering tests comparisons (automatically uses built modular tests)
