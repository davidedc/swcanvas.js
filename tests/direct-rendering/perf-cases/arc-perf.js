...
registerParametricPerfTests({
     ...
     * @param {Object} params - { strokeKey, sizeKey, angleKey, operation }
     */
    drawFunction: function(ctx, instances, params) {
        const canvasWidth = ctx.canvas.width;
        const canvasHeight = ctx.canvas.height;
        const { strokeKey, sizeKey, angleKey, operation } = params;
        ...
        // Get arc angle extent from category
        const arcAngle = getArcAngleFromCategory(angleKey, Math.random);
