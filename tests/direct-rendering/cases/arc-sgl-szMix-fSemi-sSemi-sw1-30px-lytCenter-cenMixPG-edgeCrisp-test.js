 ...
 * | StrokeThickness        | 1px-30px           | Stroke width is randomized within calculateArcTestParams, resulting in a range of 1-30px.
...
registerDirectRenderingTest(
    'arc-sgl-szMix-fSemi-sSemi-sw1-30px-lytCenter-cenMixPG-edgeCrisp',
