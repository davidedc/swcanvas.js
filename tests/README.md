...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 88 core tests + 154 visual tests + 79 direct rendering tests and cross-platform compatibility.
...
2. Automatically runs 88 modular core functionality tests from `/tests/core/` 
...
- **88 modular core tests** covering all API functionality with individual files
