...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 45 core tests + 152 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 45 individual core test files (001-037)
│   ├── 001-surface-creation-valid.js
│   ├── 015-alpha-blending-test.js  
│   ├── 031-transform-matrix-order-dependency.js
│   └── ... (33 more files)
├── visual/                        # 152 individual visual test files (001-140)
...
2. Automatically runs 45 modular core functionality tests from `/tests/core/` 
3. Automatically runs all 152 visual rendering tests with side-by-side HTML5 Canvas vs SWCanvas comparison
...
- **45 modular core tests** covering all API functionality with individual files
- **152 modular visual tests** covering all major Canvas2D features
