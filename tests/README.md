...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 72 core tests + 154 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 72 individual core test files (001-037)
...
2. Automatically runs 72 modular core functionality tests from `/tests/core/` 
...
- **72 modular core tests** covering all API functionality with individual files
