...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 44 core tests + 152 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 44 individual core test files (001-037)
...
2. Automatically runs 44 modular core functionality tests from `/tests/core/` 
...
- **44 modular core tests** covering all API functionality with individual files
