...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 75 core tests + 154 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 75 individual core test files (001-037)
...
2. Automatically runs 75 modular core functionality tests from `/tests/core/` 
...
- **75 modular core tests** covering all API functionality with individual files
