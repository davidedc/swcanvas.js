...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 85 core tests + 154 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 85 individual core test files (001-037)
...
2. Automatically runs 85 modular core functionality tests from `/tests/core/` 
...
- **85 modular core tests** covering all API functionality with individual files
