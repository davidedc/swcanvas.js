...
This directory contains the comprehensive **modular test infrastructure** for SWCanvas, with 83 core tests + 154 visual tests + 79 direct rendering tests and cross-platform compatibility.

## Modular Test Architecture

```
tests/
├── core/                          # 83 individual core test files (001-037)
...
2. Automatically runs 83 modular core functionality tests from `/tests/core/` 
...
- **83 modular core tests** covering all API functionality with individual files
